    ...
    return (
      <div className="text-center py-16 bg-zinc-900/40 border border-zinc-800/80 rounded-2xl p-8 max-w-3xl mx-auto">
        ...
        <p className="text-xs text-zinc-400 mt-1 max-w-md mx-auto">
          Submit a repository in the Agent Chat tab or select the benchmark
          repository <strong>techmedaddy/TorrentEdge</strong> to inspect the
    ...
    <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2.5 flex-wrap">
              ...
              <span className="text-zinc-400 text-xs font-mono">
                ...
                at {new Date(report.analyzedAt).toLocaleTimeString()}
              </span>
            </div>
          ...
          <div className="flex flex-wrap gap-2">
            {report.techStack.map((tech, idx) => (
              ...
              >
                ...
                <span
                  className="text-[10px] text-orange-400/90 font-mono"
                  title={`Verified via ${tech.evidence}`}
                >
      ...
      {(activeSection === "all" || activeSection === "architecture") && (
        <section
          ...
          className="bg-zinc-900/70 border border-zinc-800 rounded-xl p-5 shadow-sm"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-4">
            {report.architecture.components.map((comp, idx) => (
              <div
                key={idx}
                className="p-3 bg-zinc-950/80 border border-zinc-800 rounded-lg"
              >
          ...
          <div className="space-y-1.5 bg-zinc-950/60 p-3 rounded-lg border border-zinc-800/80">
            {report.architecture.dataFlow.map((step, idx) => (
              <div
                key={idx}
                className="flex items-start gap-2 text-xs text-zinc-300 font-sans"
              >
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-bold text-white font-mono">
                  2. API Design & Ingress
                </h3>
              </div>
              <div className="space-y-3 text-xs">
                <div>
                  <span className="text-zinc-500 block font-mono">
                    Protocol:
                  </span>
                  <span className="text-zinc-200 font-semibold">
                    {report.apiDesign.protocol}
                  </span>
                </div>
                <div>
                  <span className="text-zinc-500 block font-mono">
                    Observed Route Endpoints:
                  </span>
                  <div className="space-y-1 mt-1 font-mono">
                    {report.apiDesign.endpointsObserved.map((ep, i) => (
                      <div
                        key={i}
                        className="px-2 py-1 bg-zinc-950 rounded text-[11px] text-zinc-300 border border-zinc-800/80"
                      >
                        {ep}
                      </div>
                    ))}
                ...
                <div>
                  ...
                  <p className="text-zinc-300">
                    {report.apiDesign.errorHandling}
                  </p>
                </div>
              ...
              <div className="space-y-3 text-xs">
                <div>
                  ...
                  <p className="text-zinc-200 font-semibold">
                    {report.dataLayer.primaryStorage}
                  </p>
                </div>
                <div>
                  <span className="text-zinc-500 block font-mono">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">
                    {report.dataLayer.persistenceModel}
                  </p>
                </div>
                <div className="text-[10px] text-zinc-500 font-mono">
            ...
            >
              ...
              <div className="space-y-3 text-xs">
                <div>
                  ...
                  <p className="text-zinc-300">
                    {report.reliability.idempotency}
                  </p>
                </div>
                <div>
                  <span className="text-zinc-500 block font-mono">
                  ...
                  <p className="text-zinc-300">
                    {report.reliability.retriesAndBackoff}
                  </p>
                </div>
                <div>
                  <span className="text-zinc-500 block font-mono">
                  ...
                  <p className="text-zinc-300">
                    {report.reliability.failureHandling}
                  </p>
                </div>
                <div className="text-[10px] text-zinc-500 font-mono">
            ...
            >
              ...
              <div className="space-y-3 text-xs">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">
                    {report.observability.healthChecks}
                  </p>
                </div>
                <div className="text-[10px] text-zinc-500 font-mono">
            ...
            >
              ...
              <div className="space-y-3 text-xs">
                <div>
                  ...
                  <p className="text-zinc-300">
                    {report.security.authentication}
                  </p>
                </div>
                <div>
                  <span className="text-zinc-500 block font-mono">
                  ...
                  <p className="text-zinc-300">
                    {report.security.secretHandling}
                  </p>
                </div>
                ...
                <div>
                  <span className="text-zinc-400 font-semibold block font-mono mb-1.5">
                    Flagged Configuration Risks (
                    {report.security.vulnerabilitiesIdentified.length}):
                  </span>
                  <div className="space-y-2">
                    {report.security.vulnerabilitiesIdentified.map((v) => (
                      ...
                      >
                        <div className="flex items-center justify-between gap-1 mb-1">
                          <span className="font-semibold text-red-400 font-mono text-[11px]">
                            {v.category}
                          </span>
            ...
            >
              ...
              <div className="space-y-3 text-xs">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">
                    {report.scalability.queueingObserved}
                  </p>
                </div>
                <div>
                  <span className="text-zinc-500 block font-mono">
                ...
                <div className="pt-2 border-t border-zinc-800">
                  ...
                  <p className="text-zinc-300">
                    {report.deployment.containers} /{" "}
                    {report.deployment.orchestration}
                  </p>
                </div>
                <div>
                  <span className="text-zinc-500 block font-mono">
      ...
      {report.uncertainties.length > 0 && (
        <section
          id="section-uncertainties"
          className="p-4 bg-zinc-950/60 border border-zinc-800/60 rounded-xl text-xs text-zinc-400 font-mono"
        >
          ...
          <p className="text-[11px] text-zinc-500 mb-2">
            In compliance with strict evidence rules, the following items could
            not be conclusively determined from the repository artifacts:
          </p>
