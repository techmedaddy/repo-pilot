...
import { Bot, GitBranch, Cpu, ShieldCheck, Sparkles, Layers, FileText, ArrowLeftRight, Activity } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => setActiveTab('chat')}>
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-extrabold text-lg tracking-tight text-white font-mono">RepoPilot</span>
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-zinc-900 border border-zinc-800 text-[11px] text-zinc-300">
            ...
            <span className={hasGeminiKey ? "text-amber-400 font-medium" : "text-zinc-300 font-medium"}>
